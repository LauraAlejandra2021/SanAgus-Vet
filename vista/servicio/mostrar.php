                                        ...
                                        foreach ($dato as $key => $value) {
                                            foreach ($value as $va) { ?>
                                                <tr>
                                                    ...
                                                    <td class="text-center"><a type="button" href="../vista/servicio/edit?id=<?php echo $va["id_servi"]; ?>" class="btn bg-blue btn-circle waves-effect waves-circle waves-float">
